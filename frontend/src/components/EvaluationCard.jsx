...
export const EvaluationCard = ({ title, color, data, editando }) => {
  ...
  const titleColor = color === "purple" ? "text-purple-400" : "text-[#0291F7]";
    ...
    <div className="bg-white rounded-3xl shadow-sm border border-gray-100">
      ...
      <div className="px-8 py-6 border-b border-gray-100">
        <div>
          ...
          <p className="text-gray-500 mt-1">Resultado por competência</p>
        </div>
      </div>
          ...
          >
            ...
            <div className="mt-5 flex flex-col gap-3">
              ...
              {editando ? (
                <select
                  value={item.status}
                  onChange={(e) => alterarResultado(index, e.target.value)}
                  className="
                            w-full
                            px-5
                            py-3
