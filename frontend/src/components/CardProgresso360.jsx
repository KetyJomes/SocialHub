import { Users, CircleCheckBig, Clock3 } from "lucide-react";
    ...
    <div className="bg-white rounded-3xl border border-[#E5E7EB] shadow-sm p-8">
      ...
      <div className="flex gap-5 mt-8">
        ...
        <div className="bg-[#ECFDF5] rounded-2xl p-6 flex-1 flex items-center gap-6">
          ...
          <div>
            <p className="text-base text-gray-500">Respondidas</p>

            <h2 className="text-3xl font-bold text-gray-800">{respondidos}</h2>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 rounded-2xl p-6 flex-1 flex items-center gap-6">
          <div
            className="
                        ...
                        "
          >
            <Clock3 size={20} className="text-yellow-700" strokeWidth={2} />
          </div>

          <div>
            <p className="text-base text-gray-500">Pendentes</p>

            <h2 className="text-3xl font-bold text-gray-800">{pendentes}</h2>
          </div>
        </div>
