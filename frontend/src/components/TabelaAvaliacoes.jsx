      ...
      <div className="flex items-center gap-4">
        <div>
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-bold text-2xl">Minhas Avaliações</h2>
          </div>
        ...
        <table className="w-full table-fixed">
          <thead>
            <tr className="border-b text-gray-500">
              <th className="w-[35%] text-left px-6 py-4">Avaliações</th>

              <th className="w-[15%]">Tipo</th>

              <th className="w-[15%]">Data de conclusão</th>

              <th className="w-[15%]">Status</th>

              <th className="w-[10%]">Desempenho</th>
          ...
          <tbody>
            {avaliacoes.map((avaliacao) => (
              <LinhaAvaliacaoDash key={avaliacao.id} avaliacao={avaliacao} />
            ))}
          </tbody>
        </table>
      </div>
