...
export const ManagementEvaluationTable = ({ data, answers, onSelect }) => {
  return (
    <div
      className="
                bg-white
          ...
          <thead className="bg-white sticky top-0 z-10">
            <tr className="border-b border-gray-200">
              ...
              <th className="px-5 py-6 bg-orange-50">
                <div className="flex flex-col items-center">
                  <span className="font-semibold text-gray-800">Abaixo</span>
              ...
              <th className="px-5 py-6 bg-green-50">
                <div className="flex flex-col items-center">
                  <span className="font-semibold text-gray-800">Dentro</span>
              ...
              <th className="px-5 py-6 bg-blue-50">
                <div className="flex flex-col items-center">
                  <span className="font-semibold text-gray-800">Acima</span>
