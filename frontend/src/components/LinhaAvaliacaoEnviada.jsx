...
export const LinhaAvaliacaoEnviada = ({ avaliacao }) => {
  ...
  return (
    <tr className="border-b border-gray-100 hover:bg-gray-50 transition">
      ...
      <td className="text-center text-gray-600">{avaliacao.tipo}</td>

      <td className="text-center text-gray-600">{avaliacao.turma}</td>

      <td className="text-center text-gray-600">{avaliacao.postagem}</td>

      <td className="text-center text-gray-600">{avaliacao.prazo}</td>
