...
export const LinhaAvaliacao = ({ avaliacao }) => {
  ...
  const statusClasses = {
    ...
    "Em atraso": "bg-red-100 text-red-600",
  ...
  function selecionarAluno(aluno) {
    ...
    navigate(`/realizar-avaliacao?avaliado=${encodeURIComponent(aluno.nome)}`);
  }
      ...
      >
        <td className="px-6 py-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-semibold text-gray-800">{avaliacao.nome}</h1>
        ...
        <td className="text-center">{avaliacao.tipo}</td>
        ...
        <td className="text-center">
          <div className="flex items-center justify-center gap-2">
            ...
            <div className="flex flex-col">
              <span>{avaliacao.disponibilizada}</span>
        ...
        <td className="text-center">
          ...
          >
            ...
            {avaliacao.nome.includes("360") ? "Escolher" : avaliacao.acao}
          </button>
        </td>
      </tr>
    </React.Fragment>
