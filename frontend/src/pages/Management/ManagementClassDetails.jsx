// Visualização de uma turma em especifico
...
export const ManagementClassDetails = () => {
  ...
  const rankingAlunos = [...alunos].sort((a, b) => b.nota - a.nota);
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className=" bg-white rounded-xl border border-gray-100 shadow-sm p-5 ">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h2 className="text-xl font-bold">Competências da Turma</h2>
                </div>
              ...
              <div className=" bg-white rounded-xl border border-gray-100 shadow-sm p-5 ">
                ...
                <GraficoAluno dados={rankingAlunos} />
              </div>
            </div>
          </section>
        </div>
