...
export const ManagementFeedbackStudents = () => {
  ...
  function abrirFeedback(aluno) {
    navigate(
      `/management-comparison/${encodeURIComponent(
        "Turma 1"
        ...
        <div className="w-[90vw] max-w-[1500px] mx-auto">
          ...
          >
            <div className="flex gap-8">
              ...
              >
                Disponíveis (
                {alunos.filter((aluno) => aluno.status !== "Respondido").length}
                )
              </button>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 text-gray-500">
                  <th className="text-left px-6 py-4">Aluno</th>

                  <th className="text-center">Disponibilizado</th>
                ...
                {feedbacks.length > 0 ? (
                  feedbacks.map((aluno) => (
                    ...
                    >
                      ...
                      <td className="text-center">{aluno.disponibilizado}</td>

                      <td className="text-center">{aluno.prazo}</td>
