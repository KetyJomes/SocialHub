      ...
      <main className="pt-[12vh] px-10 pb-10">
        ...
        <div className="grid grid-cols-3 gap-5 mt-8">
          ...
          >
            <div
              className="
                        ...
                        "
            >
              <School size={30} className="text-[#007BC0]" />
            </div>

            <div>
              <h2 className="text-2xl font-bold">{dados.turmas}</h2>
          ...
          >
            ...
            <div>
              <h2 className="text-2xl font-bold">{dados.alunos}</h2>
          ...
          >
            <div
              className="
                        ...
                        "
            >
              <UserCog size={30} className="text-purple-600" />
            </div>

            <div>
              <h2 className="text-2xl font-bold">{dados.usuarios}</h2>
        ...
        <div
          className="
                ...
                "
        >
          <h2 className="text-xl font-bold text-gray-800">Acessos rápidos</h2>
            ...
            >
              <div
                className="
                            ...
                            "
              >
                <School size={22} className="text-[#007BC0]" />
              </div>

              <div>
                <h3 className="font-semibold">Gerenciar Turmas</h3>
