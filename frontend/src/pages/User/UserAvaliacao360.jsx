...
export const UserAvaliacao360 = () => {
    ...
    setColaboradores((prev) =>
      prev.map((colaborador) => {
        ...
        if (colaboradorSalvo) {
          return {
            ...colaborador,
            status: colaboradorSalvo.finalizada ? "Avaliado" : "Em andamento",
            finalizada: colaboradorSalvo.finalizada,
            respostas: colaboradorSalvo.respostas,
          };
        }
  ...
  return (
    <>
      ...
      <Header isOpen={isOpen} setIsOpen={setIsOpen} />x
      <main
        className="
                    min-h-screen
                    bg-white
      ...
      >
        <div className="mx-auto pb-12">
          ...
          <div>
            ...
            <p
              className="
                            ...
                            "
            >
              Acompanhe o andamento das avaliações e responda os colaboradores
              pendentes.
            </p>
          </div>
          ...
          <div className="mt-10">
            <CardProgresso360 colaboradores={colaboradores} />
          </div>

          {/* TABELA */}

          <section className="mt-10">
            <TabelaColaboradores360 colaboradores={colaboradores} />
          </section>
        </div>
      </main>
    </>
