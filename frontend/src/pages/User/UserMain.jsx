...
import { BarChart3, Users, ClipboardCheck, ChartColumn } from "lucide-react";
      ...
      <main className="mt-[8vh]">
        ...
        <div className="p-10">
          ...
          <div className="mt-15 flex items-center gap-4 mb-8">
            ...
            <h1 className="font-bold text-2xl">Meu Desempenho</h1>
          </div>
                ...
                <section className="w-70 bg-white rounded-3xl shadow-lg border border-gray-100 p-6">
                  ...
                  <div className="flex justify-center mt-5">
                    <div className="w-36 h-36 rounded-full border-8 border-[#0291F7] flex flex-col justify-center items-center">
                      <h1 className="text-5xl font-bold text-[#0291F7]">85%</h1>
            ...
            <section className="w-[48%]">
              <div className="flex items-center gap-5 mb-6">
                <div
                  className="
                                    ...
                                    "
                >
                  <Users size={20} className="text-[#0291F7]" strokeWidth={2} />
                </div>

                <h1 className="font-bold text-xl">Desempenho 360</h1>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <section className="w-70 bg-white rounded-3xl shadow-lg border border-gray-100 p-6">
                  ...
                  <div className="flex justify-center mt-5">
                    <div className="w-36 h-36 rounded-full border-8 border-[#0291F7] flex flex-col justify-center items-center">
                      <h1 className="text-5xl font-bold text-[#0291F7]">80%</h1>
                ...
                <GraficoPessoal
                  labels={["2025 S1", "2025 S2", "2026 S1"]}
                  values={[70, 65, 80]}
                />
              </div>
            </section>
          ...
          <div className="mt-15 flex items-start gap-4 mb-8">
            ...
            <h1 className="font-bold text-2xl">Acesso Rápido</h1>
          </div>
