                    ...
                    <section className="flex gap-8 border-b border-gray-300">
                        ...
                        <button
                            ...
                            className={`px-2 py-3 text-lg border-b-2 cursor-pointer
                                ${
                                    abaAtiva === "disponiveis" ? "text-[#2563EB] border-[#2563EB] font-semibold" : "text-gray-500 border-transparent"
                                }
                            `}
                            >
                        ...
                        <button
                            ...
                            className={`px-2 py-3 text-lg border-b-2 cursor-pointer
                            ${
                                abaAtiva === "feitas" ? "text-[#2563EB] border-[#2563EB] font-semibold" : "text-gray-500 border-transparent"
                                }
                            `}
                            >
